...
def display_matrix(user_choice):
    ...
    global list2
    global list3
    print("      {} | {} | {}                                 1 | 2 | 3 ".format(list1[0],list1[1],list1[2]))
    print('   ---------------                           ---------------           This represents')
    print("      {} | {} | {}                                 4 | 5 | 6     <------  the index positions".format(list2[0],list2[1],list2[2]))
    print('   ---------------                           ---------------           of the cells')
    print("      {} | {} | {}                                 7 | 8 | 9 ".format(list3[0],list3[1],list3[2]))
    print('\n')
...
def the_game(a,b,y,z):
    ...
    boolean = True
    while boolean == True:
        value = str(input('{} enter the cell position where you want to put your {}:\n'.format(a, y)))
...
def user_interaction():
    initial()
    x = str(input('Press y from the keyboard if you want to play the game or press n to exit: '))
    print('\n')
    if x.lower() == 'y':
